...
from routes import auth, moderators, applications, polls, announcements, server_assignments, audit_logs, easter_eggs, feature_requests, image_generation, organogram
...
api_router.include_router(organogram.router)
