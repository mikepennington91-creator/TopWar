...
async def set_moderator_email(payload: ModeratorEmailUpdate, current_user: dict = Depends(get_current_moderator), background_tasks: BackgroundTasks = BackgroundTasks()):
